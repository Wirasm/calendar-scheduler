---
agent: 'agent'
description: 'Audit type/lint suppression comments in the codebase'
---

# Audit Type/Lint Suppression Comments
...
Think deeply about each suppression before making recommendations.
