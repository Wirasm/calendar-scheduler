...
Review existing commands in `.cursor/commands/` for patterns.
...
Read 2-3 existing commands in `.cursor/commands/` for patterns:
- Frontmatter style
...
**Save command to**: `.cursor/commands/{command-name}.md`
